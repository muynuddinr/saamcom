      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="grid md:grid-cols-2">
            ...
            <div className="bg-indigo-600 p-12 text-white flex flex-col justify-center">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="ml-4">Access your order history</span>
                </div>
                <div className="flex items-center">
                  <div className="bg-indigo-500 rounded-full p-2">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="ml-4">Track your deliveries</span>
                </div>
                <div className="flex items-center">
                  <div className="bg-indigo-500 rounded-full p-2">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="ml-4">Save your favorites</span>
                </div>
              </div>
            </div>
            ...
            {/* Right Column - Form */}
            <div className="p-12">
              <h3 className="text-3xl font-semibold text-gray-900 mb-8">Sign In</h3>
